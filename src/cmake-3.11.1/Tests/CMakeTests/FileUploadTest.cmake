file(REMOVE_RECURSE "/home/yanyan/src/cmake-3.11.1/Tests/CMakeTests/uploads")

if(EXISTS "/home/yanyan/src/cmake-3.11.1/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/home/yanyan/src/cmake-3.11.1/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/home/yanyan/src/cmake-3.11.1/Tests/CMakeTests/uploads")

set(filename "/home/yanyan/src/cmake-3.11.1/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/home/yanyan/src/cmake-3.11.1/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/home/yanyan/src/cmake-3.11.1/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/yanyan/src/cmake-3.11.1/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/yanyan/src/cmake-3.11.1/Tests/CMakeTests/uploads/file2.png"
